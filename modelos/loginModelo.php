...
class loginModelo extends mainModel{   
    ...
    protected static function iniciar_sesion_modelos($datos){
        ...
        $sql=mainModel::conectar()->prepare("SELECT  usuarioId, useUser, id_tipo_usu, tbl_usua_id, usePass FROM tbl_administrador JOIN tbl_usuarios ON tbl_usuarios.identificacion = tbl_administrador.tbl_usua_id 
