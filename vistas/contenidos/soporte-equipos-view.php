                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-style mb-30 text-center">
                            <div class="text-center mt-2 texto" style="font-size: 25px;"><i class="bi bi-person-plus lead p-1"></i>Agregar Soporte Tecnico</div>
                            <form class="FormularioAjax" action="<?php echo SERVERURL; ?>ajax/soporteAjax.php" method="POST" data-form="save" autocomplete="off">
                                <div class="row mt-4">
