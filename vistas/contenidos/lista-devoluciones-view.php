...
if(isset($_GET['id_devolucion'])) {
    ...
    $id_devolucion = "No se proporcionó un ID";
}
?>
<style>
  .row {
    ...
    <div class="container-fluid">
        <div class="title-wrapper pt-30">
            ...
            <div class="card-style mb-30">
                <center>
                    <h6 class="texto"><i class="bi bi-person-check-fill p-1"></i>Equipos Devueltos Registrados</h6>
                </center>
                ...
                <div class="table-responsive text-center">
                    ...
                    echo $reg_devoluciones->paginador_devoluciones_controladores($pagina[1], 5, "", $pagina[0], "");
                    ?>
                </div>
            </div>
        </div>
