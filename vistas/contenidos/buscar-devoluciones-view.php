                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card-style mb-30 text-center">
                            <?php if (!isset($_SESSION['busqueda_devoluciones']) && empty(($_SESSION['busqueda_devoluciones']))) { ?>
                                <center>
                                ...
                                <form class="FormularioAjax1" action="<?php echo SERVERURL; ?>ajax/buscadorAjax.php" method="POST" data-form="default">
                                    <div class="input-group mt-5">
                                        ...
                                        <input class="form-control" type="search" name="Horarios_search" placeholder="Ingresa el ID">
                                        <button class="btn btn-outline-secondary" type="submit" name="accion" value="buscarDevoluciones" id="button-addon2"><i class="bi bi-search lead p-1"></i></button>
                                    </div>
                                </form>
                            <?php
                            } else { ?>
                                <div class="text-center mt-4">
                                    <h4>Resultado de la busqueda de "<strong><?php echo $_SESSION['busqueda_devoluciones']; ?></strong>"</h4>
                                ...
                                echo $reg_devoluciones->paginador_devoluciones_controladores($pagina[1], 5, "", $pagina[0], $_SESSION['busqueda_devoluciones']);
                                ?>
                            <?php } ?>
                        </div>
                    </div>
